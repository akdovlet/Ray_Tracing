...
/*   Updated: 2025/01/01 20:58:10 by akdovlet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_tuple	lighting(t_material mat, t_light light, t_tuple eyev, t_tuple normalv, t_tuple point)
{
	...
	{
		diffuse = tuple_multiply(e_color, mat.diffuse);
		diffuse = tuple_multiply(diffuse, light_dot_normal);
		...
		else
		{
			...
			specular = tuple_multiply(specular, pow(reflect_dot_eye, mat.shininess));
		}
	}
